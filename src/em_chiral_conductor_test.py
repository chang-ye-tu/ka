...
for d in [[1, 0],]:   # observed direction   
    ...
    for n in [8, 16, 32, 64, 128]:
        ...
        for l in arange(2*n):
            ...
            u[2*l + 1] = 1.j * d_nu * (c_er * hankel1(1, gamma_er * norm) + c_el * hankel1(1, gamma_el * norm))
        ...
        for l in arange(2*n):
            for m in arange(2*n):
                A[2*l + 0, 2*m + 0] = 1.j * gamma_er * (R(l - m) * L1(pi*l/n, pi*m/n, gamma_er) + pi/n * L2(pi*l/n, pi*m/n, gamma_er)) / 2 + 1.j * gamma_el * (R(l - m) * L1(pi*l/n, pi*m/n, gamma_el) + pi/n * L2(pi*l/n, pi*m/n, gamma_el)) / 2
                ...
                A[2*l + 1, 2*m + 0] = 1.j * (R(l - m) * N1(pi*l/n, pi*m/n, gamma_er) + pi/n * N2(pi*l/n, pi*m/n, gamma_er)) / 2 - 1.j * (R(l - m) * N1(pi*l/n, pi*m/n, gamma_el) + pi/n * N2(pi*l/n, pi*m/n, gamma_el)) / 2
