...
for case in ['chiral_conductor', 'achiral_chiral', 'chiral_achiral', 'chiral_chiral',]: # 'achiral_chiral_3d', 'chiral_chiral_3d', 'chiral_achiral_3d',]: 
...
%s'''
    ...
    def make_q():
        ...
        sl = []
        if n == 2:
            q_rules.extend([('psi[1]', 'z[2*l]'), ('psi[2]', 'z[2*l+1]')])

        elif n == 4:
            q_rules.extend([('psi[1]', 'z[4*l]'), ('psi[2]', 'z[4*l+1]'), ('psi[3]', 'z[4*l+2]'), ('psi[4]', 'z[4*l+3]')])
